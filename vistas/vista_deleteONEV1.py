...
class Ventana:
    ...
    def __init__(self, root):
        ...
        self.label_01 = Label(self.frame_01, text="Nombre:",
        ...
        self.campo_nombre_archivo = Entry(self.frame_01, font=("arial", 12), state="readonly",
        ...
        self.btn_si = Button(self.frame_02, text="Borrar", font=("arial", 12))
